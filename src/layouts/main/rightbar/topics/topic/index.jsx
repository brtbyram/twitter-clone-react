    ...
    return (
        <Link to="/" className="py-3 px-4 transition-colors hover:bg-white/[0.03] relative">
            ...
            <Popover className="absolute top-1.5 right-2">
                <Popover.Button className="w-[34.75px] h-[34.75px] rounded-full outline-none text-[#71767b] flex items-center justify-center hover:bg-[#1d9bf01a] hover:text-[#1d9bf0] transition-colors">
                ...
                <Popover.Panel className="w-[384px] rounded-xl grid absolute top-2 right-0 bg-black shadow-box z-[1] overflow-hidden">
                    <button className="py-3 px-4 text-left flex items-center gap-3 text-[15px] leading-4 font-bold text-[#e7e9ea] hover:bg-white/[0.3] transition-colors">
