    ...
    return (
        <Link to="/" className="py-3 px-4 transition-colors hover:bg-white/[0.03] relative">
            ...
            <Popover className="absolute top-1.5 right-2">
                ...
                <Popover.Panel className="w-[384px] rounded-xl grid absolute top-2 right-0 bg-[color:var(--background-primary)] shadow-box z-[1] overflow-hidden">
                    <button className="py-3 px-4 text-left flex items-center gap-3 text-[15px] leading-4 font-bold hover:bg-white/[0.3] transition-colors">
