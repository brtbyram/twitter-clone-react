...
import { setBackgroundColor, setColor, setBoxShadow, setFontSize } from "~/store/appearance/actions";
        ...
        <div className="w-[600px]">
            ...
            <div className="p-8 pt-0">
                <p className="text-center text-[color:var(--color-base-secondary)] leading-5 text-[0.938rem] mb-5">
                    Bu ayarlar, bu tarayıcıddaki tüm X hesaplarını etkiler
                </p>
                <div className="mx-8 mb-4">
                    <div className="border border-[color:var(--background-third)] px-4 py-3 gap-3 flex rounded-xl">
                        <img
                ...
                <div className="grid gap-3">
                    <section>
                        ...
                        <div className="p-4 bg-[color:var(--background-secondary)] rounded-2xl flex items-center gap-5">
                            <div className="text-[0.813rem]">Aa</div>
                            <div className="h-1 flex-1 rounded-full bg-[color:var(--color-secondary)] relative">
                                <div style={{ width: fontSizePercent }} className="h-full top-0 left-0 rounded-full bg-[color:var(--color-primary)] relative" />
                                <div className="flex justify-between absolute -top-3.5 -left-[8px] w-[calc(100%+16px)]"> 
                                    {fontSizes.map((fs, index) => (
                                        <button
                                            ...
                                            className={classNames("w-8 h-8  rounded-full flex items-center justify-center relative before:absolute before:inset-0 before:rounded-full before:hover:bg-[color:var(--color-primary)] before:opacity-10", {
                    ...
                    <section>
                        <h6 className="text-[color:var(--color-base-secondary)] mb-1 leading-5 text-[13px] font-bold">Renkler</h6>
                        <div className="py-2 bg-[color:var(--background-secondary)] rounded-2xl flex justify-around items-center">
                            {colors.map((c, index) => (
                                <button
                                    key={index}
                                    onClick={() => { setColor({ ...color, ...c }) }}
                                    style={{ '--bg': c.primary }}
                    ...
                    <section>
                        ...
                        <div className="py-2 px-4 mb-3 grid gap-2 grid-cols-3 bg-[color:var(--background-secondary)] rounded-2xl">
                            <button
                                ...
                                className={classNames("h-[62px] pr-3 pl-2 bg-white text-[#0f1419] border font-bold border-black/10 rounded group flex items-center gap-1.5", {
                                    "!border-[color:var(--color-primary)] !border-2": backgroundColor.name === 'light'
                                })}>
                                <div className="w-[40px] h-[40px] rounded-full flex flex-shrink-0 items-center justify-center group-hover:bg-black/5">
                            ...
                            <button
                                ...
                                <div className="w-[40px] h-[40px] rounded-full flex flex-shrink-0 items-center justify-center group-hover:bg-white/5">
                                    <div className={classNames("w-[20px] h-[20px] rounded-full border-[2px] border-[#b9cad3] ", {
